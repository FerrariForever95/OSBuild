...
extern const struct _mp_obj_module_t mp_module_moclcd;
#undef MODULE_DEF_MOCLCD
#define MODULE_DEF_MOCLCD { MP_ROM_QSTR(MP_QSTR_moclcd), MP_ROM_PTR(&mp_module_moclcd) },
