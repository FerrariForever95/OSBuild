/*
 * moclcd.c — High-performance 8080 8-bit parallel LCD driver for MicroPython.
 * Engineered for ESP32-S3 using ESP-IDF esp_lcd GDMA pipeline.
 *
 * Pin Map:
 * - RST: GPIO 12
 * - RS (DC): GPIO 13
...
/* 4096 pixels = 8192 bytes DMA scratch buffer allocated in fast internal SRAM */
