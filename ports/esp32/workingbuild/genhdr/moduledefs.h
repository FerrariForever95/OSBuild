...
extern const struct _mp_obj_module_t modili9488_module;
#undef MODULE_DEF_ILI9488
#define MODULE_DEF_ILI9488 { MP_ROM_QSTR(MP_QSTR_ili9488), MP_ROM_PTR(&modili9488_module) },
...
extern const struct _mp_obj_module_t mp_module_zfs;
#undef MODULE_DEF_ZFS
#define MODULE_DEF_ZFS { MP_ROM_QSTR(MP_QSTR_zfs), MP_ROM_PTR(&mp_module_zfs) },
...
#define MICROPY_HAVE_REGISTERED_EXTENSIBLE_MODULES  20
